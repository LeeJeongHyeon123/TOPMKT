...
try {
    ...
    $juneEvents = [
        [
            'title' => '여름 마케팅 전략 워크샵',
            'description' => '뜨거운 여름 시즌을 공략하는 마케팅 전략을 배우는 워크샵입니다. 여름 상품 마케팅, 휴가철 타겟팅, 시즌 프로모션 기획 등 실전 노하우를 공유합니다.',
            'instructor_name' => '김여름',
            'instructor_info' => '시즌 마케팅 전문가로 10년 이상 여름 시즌 캠페인을 성공시킨 경험이 있습니다.',
            ...
            'venue_address' => '서울특별시 강남구 테헤란로 456',
            'max_participants' => 40,
