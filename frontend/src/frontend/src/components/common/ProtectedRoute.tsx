...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
  ...
  // requireRole이 있으면 requiredRole보다 우선 사용
  const roleToCheck = requireRole || requiredRole;
  ...
  if (roleToCheck && user.role !== roleToCheck) {
    ...
    if ((roleToCheck === 'ROLE_ADMIN' || roleToCheck === 'admin') && user.role !== 'ROLE_ADMIN') {
      return fallback || (
