...
import { Post, LectureEnrollment, Notification } from '../../types';
...
const MyPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchMyPageData = async () => {
      ...
      try {
        // 내가 작성한 게시글
        const postsResponse = await execute({
          url: '/posts',
          method: 'GET',
          params: {
            user_id: user.id,
        ...
        // 수강 중인 강의
        const enrollmentsResponse = await execute({
          url: '/my/enrollments',
          method: 'GET',
          params: {
            per_page: 5,
        ...
        // 알림
        const notificationsResponse = await execute({
          url: '/notifications',
          method: 'GET',
          params: {
            per_page: 5,
        ...
        // 통계 데이터
        const statsResponse = await execute({
          url: '/my/stats',
          method: 'GET',
        });
