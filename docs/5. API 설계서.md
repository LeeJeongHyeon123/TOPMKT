...
**문서 버전:** v2.3 (Rev3)  
**최종 수정일:** 2025-06-09 21:52:00 KST
...
7. [댓글 관리 API](#댓글-관리-api) **🆕 구현 완료**  
   - [댓글 목록 조회 (GET /api/comments)](#댓글-목록-조회-get-apicomments)  
   - [댓글 작성 (POST /api/comments)](#댓글-작성-post-apicomments)  
   - [댓글 수정 (PUT /api/comments/{id})](#댓글-수정-put-apicommentsid)  
   - [댓글 삭제 (DELETE /api/comments/{id})](#댓글-삭제-delete-apicommentsid)  
