...
=======
    <!-- CSS 파일 링크 -->
>>>>>>> 32ef1d6bf786e7b6349fdebc719b5e1d030d3aee
    <link rel="stylesheet" href="/public/assets/css/main.css">
    <link rel="stylesheet" href="/public/assets/css/auth.css">
    <link rel="stylesheet" href="/resources/css/header.css">
    
    <!-- reCAPTCHA Enterprise -->
    <script src="https://www.google.com/recaptcha/enterprise.js?render=6LfCdjErAAAAAL6YKLyHV_bt9of-8FNLCoOhW9C4" async defer></script>
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                if (!firebase.apps.length) {
                    ...
                    console.log('[Firebase] Core 초기화 성공');
                    
                    // 2. Authentication 초기화
                    firebase.auth();
                    console.log('[Firebase] Authentication 초기화 성공');
...
<<<<<<< HEAD
                ...
                <form class="auth-form" id="registerForm" style="display:none;">
                    ...
                    <div class="form-group verification-group" id="registerVerificationGroup" style="display:none;">
                        ...
                        <div class="verification-input-group">
                            <input type="text" id="verificationCode" name="verificationCode" placeholder="인증번호 6자리" maxlength="6" pattern="\d*" inputmode="numeric">
                            <div class="verification-timer" id="registerVerificationTimer"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">문자, 숫자, 언더바만 사용 가능합니다.</small>
                    </div>
                    <div class="form-group">
                        <label for="registerCountry">거주 국가</label>
                        <select id="registerCountry" name="country" required>
                    ...
                    <div class="form-group">
                        <label for="registerLanguage">사용 언어</label>
                    ...
                    <div class="register-submit-group">
                        <button type="submit" class="register-submit-btn" id="registerSubmitBtn" style="display: block;">회원가입 완료</button>
                    </div>
                </form>
            </div>
    ...
    <script src="/public/assets/js/auth-verification.js"></script>
    <script src="/public/assets/js/auth-country.js"></script>
</body>
</html> 
=======
<?php
